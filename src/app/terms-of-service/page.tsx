      ...
      <div className="py-[27px] w-[90%] md:w-[80%] mx-auto">
        <div className="aria-font">
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            use of this website and the services offered through it (collectively, “Services”),
          ...
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500]">
            ...
            . {siteConfig.supportedBy.name} supplies the hosting and infrastructure;{' '}
            {siteConfig.name} remains responsible for this site&apos;s content and for these Terms.{' '}
            {siteConfig.supportedBy.name}&apos;s own terms govern its separate services and are not
            incorporated into these Terms. How this arrangement affects your personal data is set
          ...
          <ContactDetails />
          <p className="text-[14px] text-[#666] pb-[10px] leading-[24px] font-[500] pt-[10px]">
